...
vector < vector <float> > blur(vector < vector < float> > grid, float blurring) {
    ...
    float corner_prob = blurring / 12;
  	...
  	row1.push_back(corner_prob);
  	row1.push_back(adjacent_prob);
  	row1.push_back(corner_prob);
  	row2.push_back(adjacent_prob);
  	row2.push_back(center_prob);
  	row2.push_back(adjacent_prob);
  	row3.push_back(corner_prob);
  	row3.push_back(adjacent_prob);
  	row3.push_back(corner_prob);
